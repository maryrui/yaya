...
$datas[] = "ALTER TABLE  `ims_users_group` ADD `timelimit` int(10) unsigned NOT NULL;";

$datas[] = "INSERT INTO `ims_users_group` (`id`, `name`, `package`, `maxaccount`, `maxsubaccount`, `timelimit`) VALUES
(1, '体验用户组', 'a:2:{i:0;i:1;i:1;i:-1;}', 3, 1, 1000),
(2, '白金用户组', 'a:2:{i:0;i:1;i:1;i:-1;}', 20, 2, 2000),
(3, '黄金用户组', 'a:2:{i:0;i:1;i:1;i:-1;}', 30, 3, 3000);";
...
('111', '0', '应用商店', 'members', '', 'fa fa-cubes', '', '0', 'url', '1', '1', ''),
('112', '111', '应用管理', 'members', '', '', '', '0', 'url', '1', '1', ''),
('140', '112', '记录查询', 'members', './index.php?c=members&a=mrecord&', '', '', '0', 'url', '1', '1', 'members_mrecord'),
('141', '112', '用户管理', 'members', './index.php?c=members&a=muser&', '', '', '0', 'url', '1', '1', 'members_muser'),
...
('142', '133', '收银台关键字', 'mc', './index.php?c=platform&a=cover&do=clerk', '', '', 0, 'url', 1, 1, 'paycenter_clerk'),
('143', '120', '多平台接入', 'fournet',  '', '', '', '0', 'url', '1', '1', ''),
('144', '143', '接入平台', 'fournet', './index.php?c=fournet&a=wxauth&do=mplist&', '', '', '0', 'url', '1', '1', 'fournet_wxauth_mplist'),
('145', '143', '使用统计', 'fournet', './index.php?c=fournet&a=wxauth&do=static&', '', '', '0', 'url', '1', '1', 'fournet_wxauth_static'),
('146', '143', '使用帮助', 'fournet', './index.php?c=fournet&a=wxauth&do=help&', '', '', '0', 'url', '1', '1', 'fournet_wxauth_help'),
('147', '120', '域名智能绑定', 'fournet',  '', '', '', '0', 'url', '1', '1', ''),
('148', '147', '域名管理', 'fournet', './index.php?c=fournet&a=domain&do=manage&', '', '', '0', 'url', '1', '1', 'fournet_domain_manage'),
('149', '147', '使用帮助', 'fournet', './index.php?c=fournet&a=domain&do=help&', '', '', '0', 'url', '1', '1', 'fournet_domain_help'),
('150', '120', '全局信息通知管理', 'fournet',  '', '', '', '0', 'url', '1', '1', ''),
('151', '150', '全局邮件通知设置','fournet','./index.php?c=profile&a=notify','','','0','url','1','1','profile_notify'),
('152', '150', '全局短信设置', 'fournet', './index.php?c=fournet&a=msg', '', '', '0', 'url', '1', '1', 'fournet_msg'),
('153', '150', '全局打印机设置', 'fournet', './index.php?c=fournet&a=print', '', '', '0', 'url', '1', '1', 'fournet_print');
...
ALTER TABLE `ims_mc_credits_recharge` CHANGE `tid` `tid` varchar(64) NOT NULL;

ALTER TABLE `ims_mc_mass_record` ADD `group` int(10) NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `attach_id` int(10) unsigned NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `media_id` varchar(100) NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `type` tinyint(3) unsigned NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `status` tinyint(3) unsigned NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `cron_id` int(10) unsigned NOT NULL;
ALTER TABLE `ims_mc_mass_record` ADD `sendtime` int(10) unsigned NOT NULL;

ALTER TABLE `ims_mc_members` ADD `credit6` decimal(10,2) NOT NULL;
...
CREATE TABLE IF NOT EXISTS `ims_buymod_modules` (
  ...
  `module` varchar(50) NOT NULL,
  `price` decimal(10,2) unsigned NOT NULL,
  `outLink` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_buymod_payset` (
  ...
  `alipaypartner` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wxauth_list` (
  ...
  `token` char(32) NOT NULL,
  `encodingaeskey` char(43) NOT NULL,
  `is_yz` tinyint(1) unsigned NOT NULL,
  `status` tinyint(1) NOT NULL,
  `is_delete` tinyint(1) unsigned NOT NULL,
  `create_time` int(10) unsigned NOT NULL,
  `desc` varchar(100) NOT NULL,
...
ALTER TABLE `ims_uni_settings` ADD `msg` varchar(2000) NOT NULL;
ALTER TABLE `ims_uni_settings` ADD `print` varchar(2000) NOT NULL;

ALTER TABLE `ims_mc_credits_recharge` CHANGE `tag` `tag` varchar(10) NOT NULL;
ALTER TABLE `ims_modules` ADD `price` decimal(10,2) unsigned DEFAULT NULL;
...
ALTER TABLE `ims_users_group` ADD `price` decimal(10,2) unsigned DEFAULT NULL;
...
ALTER TABLE `ims_agent_copyright` ADD `pifu` varchar(30) NOT NULL;
ALTER TABLE `ims_users_group` ADD `domain` int(10) NOT NULL;
...
ALTER TABLE `ims_article_product` ADD `price` decimal(10,2) DEFAULT NULL;
ALTER TABLE `ims_uni_settings` ADD `shenhe` varchar(10) NOT NULL;

ALTER TABLE `ims_activity_clerks` change `password` `password` varchar(50) NOT NULL;
ALTER TABLE `ims_activity_clerks` ADD INDEX `uniacid` (`uniacid`);
ALTER TABLE `ims_activity_clerks` ADD INDEX `password` (`password`);
ALTER TABLE `ims_activity_clerks` ADD INDEX `openid` (`openid`);

ALTER TABLE `ims_activity_stores` ADD `source` tinyint(3) unsigned NOT NULL;
ALTER TABLE `ims_activity_stores` ADD INDEX `location_id` (`location_id`);

ALTER TABLE `ims_core_paylog` change `acid` `acid` int(10) NOT NULL;
ALTER TABLE `ims_core_paylog` change `uniontid` `uniontid` varchar(64) NOT NULL;

ALTER TABLE `ims_coupon` ADD `dosage` int(10) unsigned DEFAULT NULL;

ALTER TABLE `ims_coupon_modules` ADD `couponid` int(10) unsigned NOT NULL;
ALTER TABLE `ims_coupon_modules` ADD INDEX `couponid` (`couponid`);

ALTER TABLE `ims_coupon_record` ADD `couponid` int(10) unsigned NOT NULL;
ALTER TABLE `ims_coupon_record` ADD `uid` int(10) unsigned NOT NULL;
ALTER TABLE `ims_coupon_record` ADD `grantmodule` varchar(255) NOT NULL;
ALTER TABLE `ims_coupon_record` ADD `remark` varchar(255) NOT NULL;

ALTER TABLE `ims_mc_card` change `grant` `grant` varchar(3000) NOT NULL;
ALTER TABLE `ims_mc_card` change `grant_rate` `grant_rate` varchar(20) NOT NULL;

ALTER TABLE `ims_mc_mapping_fans` change `groupid` `groupid` varchar(30) NOT NULL;

ALTER TABLE `ims_mc_members` ADD `credit20` decimal(10,2) NOT NULL;
ALTER TABLE `ims_mc_members` ADD INDEX `email` (`email`);
ALTER TABLE `ims_mc_members` ADD INDEX `mobile` (`mobile`);
...
-- www.chaojiym.com 
ALTER TABLE `ims_core_cron` CHANGE `cloudid` `cloudid` int(10) NOT NULL;
ALTER TABLE `ims_core_cron` CHANGE `uniacid` `uniacid` int(10) NOT NULL;
ALTER TABLE `ims_core_cron` CHANGE `type` `type` varchar(5) NOT NULL;
ALTER TABLE `ims_core_cron` CHANGE `status` `status` tinyint(1) NOT NULL;

ALTER TABLE `ims_core_cron` ADD `value` varchar(15) NOT NULL;
ALTER TABLE `ims_core_cron` ADD `url` varchar(100) NOT NULL;
ALTER TABLE `ims_core_cron` ADD `open` tinyint(1) NOT NULL;

-- www.chaojiym.com
ALTER TABLE `ims_core_cron` CHANGE `extra` `extra` varchar(500) NOT NULL;
ALTER TABLE `ims_core_cron` CHANGE `url` `url` varchar(200) NOT NULL;


-- www.chaojiym.com
ALTER TABLE `ims_agent_copyright` CHANGE `uid` `uid` int(5) unsigned NOT NULL;
ALTER TABLE `ims_agent_copyright` ADD `id` int(10) NOT NULL;



------------------------------------
ALTER TABLE `ims_core_queue` ADD INDEX `dateline` ( `dateline` );
