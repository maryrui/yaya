...
<div class="clearfix">
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
			...
			<div class="modal-dialog">
				<div class="modal-content" style="width:740px;">
					...
					<div class="modal-body">
						...
						<span class="help-block"><?php  if(IMS_FAMILY == 'x') { ?>欢迎关注<?php  echo $account['name'];?><?php  } else { ?>微赞是一款免费开源的微信公众平台管理系统。<?php  } ?></span>
					</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://bbs.012wz.com//" target="_black">查看详情</a><?php  } ?></p>
			</div>
		</div>
		<?php  if(!empty($acid)) { ?>
			<div class="form-group">
		...
		<?php  } ?>
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">公众号认证文件</label>
			<div class="col-sm-9 col-xs-12">
				<input type="file" name="renzheng" value="">
				<span class="help-block">公众号设置网页授权回调域名时，提示需要上传认证文件。请下载下来，并在此处上传。</span>
			</div>
		</div>
		<div class="form-group">
