		...
		<div class="row">
				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu" style="padding-right: 0px;">
					...
					<div class="panel panel-default">
						...
						<?php  if($_W['isfounder']) { ?>
						<div class="panel-heading" style='padding: 14px 15px;'>
							<h4 class="panel-title"><i class="fa fa-cloud-download"></i> 云服务</h4>
							<a class="panel-collapse collapsed" data-toggle="collapse" href="#frame-1">
								<i class="fa fa-chevron-circle-down"></i>
							</a>
						</div>
						<ul class="list-group collapse in" id="frame-1">
							<li class="list-group-item " onclick="window.location.href = '<?php  echo url('cloud/upgrade');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="一键更新">
									<a class="pull-right" href="<?php  echo url('cloud/upgrade');?>"><i class="fa fa-cloud-download"></i></a>
									一键更新
							</li>

							<li class="list-group-item" onclick="window.location.href = 'http://www.chaojiym.com';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="应用商城">
									<a class="pull-right" href="<?php  echo url('cloud/appstore');?>"><i class="fa fa-joomla"></i></a>
									应用商城
							</li>
