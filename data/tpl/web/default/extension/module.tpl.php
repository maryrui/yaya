...
<div class="clearfix">
	...
	<div ng-controller="listInstallModules">
		<div class="form" >
			<h5 class="page-header" ng-show="modules.length > 0">已购买的模块</h5>
		</div>
			...
			<div class="media">
				<div class="pull-right" style="width:230px;">
					<div class="module-set">
						...
						<a href="<?php echo ADDONS_URL;?>/web/index.php?c=store&a=author&do=application&id={{m.id}}" target="_blank">查看详情</a>
				...
				<img class="media-object img-rounded gray" ng-src="<?php echo ADDONS_URL;?>/resource/attachment/{{m.thumb}}" onerror="this.src='../web/resource/images/nopic-small.jpg'">
				<div class="media-body">
					<h4 class="media-heading">
			...
			<div class="media">
				<div class="pull-right" style="width:230px;">
					<div class="module-set">
						...
						&nbsp;
						<a onclick="return confirm('确定要将模块放入回收站吗？'); return false;" href="<?php  echo url('extension/module/recycle', array('name' => $row['name'], 'op' => 'delete'))?>">放入回收站</a>
						<?php  } else { ?>
		...
		<div class="item" ng-repeat="m in modules">
			<div class="media">
				<div class="pull-right" style="width:230px;">
					<div class="module-set">
						<a href="<?php  echo url('extension/module/install')?>m={{m.name.toLowerCase()}}">安装</a>
						<a href="<?php echo ADDONS_URL;?>/web/index.php?c=store&a=application&id={{m.id}}" target="_blank">查看详情</a>
						&nbsp;
					</div>
				</div>
				<img class="media-object img-rounded gray" ng-src="http://addons2.weizancms.com/resource/attachment/{{m.thumb}}" onerror="this.src='../web/resource/images/nopic-small.jpg'">
				<div class="media-body">
					<h4 class="media-heading">
						{{m.title}}<small>（标识：{{m.name}}&nbsp;&nbsp;&nbsp;版本：{{m.version}}&nbsp;&nbsp;&nbsp;作者：{{m.author}}）</small>
					</h4>
